...
export class DropSellerApprovalGate1785186412562 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_46366e52d27edeffdf052f992f"`);
        await queryRunner.query(`ALTER TYPE "public"."reports_targettype_enum" RENAME TO "reports_targettype_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."reports_targettype_enum" AS ENUM('post', 'comment', 'user', 'listing')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_46366e52d27edeffdf052f992f" ON "reports" ("targetType", "targetId") `);
        await queryRunner.query(`ALTER TABLE "seller_profiles" ADD CONSTRAINT "FK_49de7dde25d76b120677be9aedd" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_46366e52d27edeffdf052f992f"`);
        await queryRunner.query(`CREATE TYPE "public"."reports_targettype_enum_old" AS ENUM('post', 'comment', 'user')`);
        await queryRunner.query(`ALTER TABLE "reports" ALTER COLUMN "targetType" TYPE "public"."reports_targettype_enum_old" USING "targetType"::"text"::"public"."reports_targettype_enum_old"`);
        await queryRunner.query(`DROP TYPE "public"."reports_targettype_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."reports_targettype_enum_old" RENAME TO "reports_targettype_enum"`);
        await queryRunner.query(`CREATE INDEX "IDX_46366e52d27edeffdf052f992f" ON "reports" ("targetId", "targetType") `);
        ...
        `);
        await queryRunner.query(`UPDATE "users" SET "sellerStatus" = 'approved' FROM "seller_profiles" WHERE "users"."id" = "seller_profiles"."userId"`);
