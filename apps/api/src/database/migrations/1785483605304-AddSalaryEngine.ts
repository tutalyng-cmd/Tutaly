...
export class AddSalaryEngine1785483605304 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_6155d4dbce69bbf1ebd08e0eb7" ON "salaries" ("company_id") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_9f61c95a7ba0b28c58b1d0bc67" ON "salaries" ("canonical_job_title") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_0982701f3169a31eca30e48ddd" ON "salaries" ("location") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_42b171005631ae19e6b93a3353" ON "salaries" ("status") `,
    );
    await queryRunner.query(
      `CREATE TABLE "salary_aggregates" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "canonical_job_title" character varying(150) NOT NULL, "location" character varying(150) NOT NULL DEFAULT 'ALL', "median_pay" numeric(12,2) NOT NULL, "p25_pay" numeric(12,2) NOT NULL, "p75_pay" numeric(12,2) NOT NULL, "min_pay" numeric(12,2) NOT NULL, "max_pay" numeric(12,2) NOT NULL, "sample_count" integer NOT NULL DEFAULT '0', CONSTRAINT "PK_33f202a3bf7f0f29006a45d658d" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE UNIQUE INDEX "IDX_b7a73106f8ff7b7bb23b06dc49" ON "salary_aggregates" ("canonical_job_title", "location") `,
    );

    await queryRunner.query(
      `ALTER TABLE "salaries" ADD CONSTRAINT "FK_6155d4dbce69bbf1ebd08e0eb7a" FOREIGN KEY ("company_id") REFERENCES "companies"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "salaries" ADD CONSTRAINT "FK_c12591382bdd41fa79264f339e0" FOREIGN KEY ("user_id") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "company_reviews" ALTER COLUMN "reviewTitle" SET DEFAULT 'Review'`,
    );
    await queryRunner.query(
      `ALTER TABLE "company_reviews" ALTER COLUMN "isCurrentEmployee" SET DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "company_reviews" ALTER COLUMN "jobTitle" SET DEFAULT 'Employee'`,
    );
    await queryRunner.query(`ALTER TABLE "notifications" DROP COLUMN "type"`);
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_b7a73106f8ff7b7bb23b06dc49"`,
    );
    await queryRunner.query(`DROP TABLE "salary_aggregates"`);
    await queryRunner.query(
      `DROP INDEX "public"."IDX_42b171005631ae19e6b93a3353"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_0982701f3169a31eca30e48ddd"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_9f61c95a7ba0b28c58b1d0bc67"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_6155d4dbce69bbf1ebd08e0eb7"`,
    );
