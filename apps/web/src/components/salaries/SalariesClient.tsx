            ...
            <div className="flex w-full gap-2 bg-white rounded-xl p-2 shadow-lg">
              <div className="relative flex-1">
                ...
                <input 
                  ...
                  className="w-full pl-10 pr-3 py-2 border-0 focus:ring-0 text-gray-900 bg-transparent outline-none"
                />
              </div>
                  ...
                  <div key={idx} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div className="flex items-center gap-3 mb-4">
                      ...
                      <div>
                        ...
                        <h3 className="text-2xl font-bold text-gray-900">{agg.currency || 'NGN'} {Number(agg.avgSalary).toLocaleString()}</h3>
                      </div>
                    </div>
